...
summary_table = pd.DataFrame({
    'Parameter': [
        ...
        'Mass Flow Rate (kg/min)', 'Expected Ra (μm)', 'Expected MRR (mm³/min)'
    ],
    'Best Quality (Min Ra)': [
        best_quality['pressure_MPa'], best_quality['standoff_distance_mm'], best_quality['traverse_speed_mm_min'],
        best_quality['mass_flow_rate_kg_min'], best_quality['surface_roughness_um'], best_quality['material_removal_rate_mm3_min']
    ],
    'Best Productivity (Max MRR)': [
        ...
        best_productivity['mass_flow_rate_kg_min'], best_productivity['surface_roughness_um'], best_productivity['material_removal_rate_mm3_min']
    ],
    'Balanced': [
        balanced['pressure_MPa'], balanced['standoff_distance_mm'], balanced['traverse_speed_mm_min'],
        balanced['mass_flow_rate_kg_min'], balanced['surface_roughness_um'], balanced['material_removal_rate_mm3_min']
    ]
})

print("="*70)
print("Table: Optimal Process Parameter Settings for Different Objectives")
print("="*70)
