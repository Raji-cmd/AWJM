...
# ------------------- Metrics -------------------
metrics = {
    'surface_roughness_um': {'RMSE': 0.1194, 'MAE': 0.1011, 'R2': 0.9633},
    'material_removal_rate_mm3_min': {'RMSE': 2.9201, 'MAE': 2.3389, 'R2': 0.9589},
    'kerf_angle_deg': {'RMSE': 0.0678, 'MAE': 0.0567, 'R2': 0.9401}
}
