...
# Model configurations for each target (Ridge, RF, ElasticNet, SVR)
model_configs = {
    "surface_roughness": {
        "Ridge": Ridge(alpha=1),
...
# Save to Excel
final_excel_df.to_excel("Hyperparameter_All_Data_SVR_ElasticNet.xlsx", index=False)
print("\nResults saved to Hyperparameter_All_Data_SVR_ElasticNet.xlsx")
